...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, InventoryResponse> inventoryResponse() {
		return createFactory(InventoryResponse.class);
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, PaymentEvent> paymentEvent() {
		return createFactory(PaymentEvent.class);
	}
